...
// import {
//   SiFastapi, SiFramer, SiPostgresql, SiPostman,SiSqlalchemy,SiVite,SiRedis, SiGithubactions, SiTerraform, SiKubernetes, SiAws
// } from "react-icons/si";
...
//     skills: [
//       { name: "SQLAlchemy", icon: <SiSqlalchemy size="1em" color="#009688" /> },
...
//       { name: "Vite", icon: <SiVite size="1em" color="#009688" /> },
//     ],
//   },
//   {
//     title: "Database",
...
//       { name: "Redis", icon: <SiRedis size="1em" color="#336791" /> },
//     ],
//   },
//   {
//     title: "DevOps & Cloud",
//     skills: [
//       { name: "Docker", icon: <SiFramer size="1em" color="#009688" /> },
//       { name: "AWS", icon: <FaAws size="1em" color="#009688" /> },
//       { name: "Terraform", icon: <SiTerraform size="1em" color="#009688" /> },
//       { name: "GitHub Actions", icon: <SiGithubactions size="1em" color="#009688" /> },
...
// FIXED: Removed SiSqlalchemy and SiAws, Added SiDocker and SiSwagger
import {
  SiFastapi, SiPostgresql, SiPostman, SiVite, SiRedis, 
  SiGithubactions, SiTerraform, SiDocker, SiSwagger, SiPytorch, SiScikitlearn, SiHuggingface
} from "react-icons/si"; 
import { VscCode } from "react-icons/vsc";
import { motion } from "framer-motion";
...
const skillGroups = [
  ...
  },
  {
    title: "Backend Development",
    skills: [
      // FIXED: Used Python icon for SQLAlchemy as a placeholder
      { name: "SQLAlchemy", icon: <FaPython size="1em" color="#306998" /> }, 
      { name: "FastAPI", icon: <SiFastapi size="1em" color="#009688" /> },
    ],
  },
  {
  ...
  },
  {
    title: "DevOps & Cloud",
    skills: [
      { name: "Docker", icon: <SiDocker size="1em" color="#009688" /> }, 
      { name: "AWS", icon: <FaAws size="1em" color="#009688" /> },
      { name: "Terraform", icon: <SiTerraform size="1em" color="#009688" /> },
      { name: "GitHub Actions", icon: <SiGithubactions size="1em" color="#009688" /> },
    ],
  },
  {
    ...
    skills: [
      { name: "PyTorch", icon: <SiPytorch size="1em" color="#009688" /> }, 
      { name: "Scikit-learn", icon: <SiScikitlearn size="1em" color="#009688" /> },
      { name: "HuggingFace Transformers", icon: <SiHuggingface size="1em" color="#009688" /> },
    ],
  },
  {
    title: "Developer Tools",
    skills: [
      ...
      { name: "GitHub", icon: <FaGithub size="1em" color="#ffffff" /> },
      { name: "VS Code", icon: <VscCode size="1em" color="#0078d7" /> },
      { name: "Swagger", icon: <SiSwagger size="1em" color="#009688" /> }, 
      { name: "Postman", icon: <SiPostman size="1em" color="#FF6C37" /> },
    ],
  },
];
